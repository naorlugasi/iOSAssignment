...
class CoreDataStack {
    ...
    static var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle(for: CoreDataStack.self).url(forResource: "iOSAssignment", withExtension: "momd")! // type your database name here..
    ...
    static var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = applicationDocumentsDirectory.appendingPathComponent("iOSAssignment.sqlite") // type your database name here...
